...
# -----------------------------------------------------------------------------------------
    ...
    return str(max_cr_conf)+" mbps", Overbooking_Ratio, equation, str(y_pred_CIR_Conf_Max_round)+" mbps", str(left)+" mbps", trace1, trace3, trace4, predictionTbl_df[["Bandwidth Sold", "Bandwidth Required"]].to_dict('records'), trace6, trace2
