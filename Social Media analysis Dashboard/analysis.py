...
app.layout = dbc.Container([
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardImg(src="/static/images/linkedinlogo2.png", top=True),

            ],className='mb-2'), #add space between rows 

            dbc.Card([
                dbc.CardBody([
                    dbc.CardLink(
                        "Ayrade ...", target="_blank",
                                 href="https://www.youtube.com/user/AYRADE"
                    )
...
], fluid=True ,style={'margin-left':'120px'})
